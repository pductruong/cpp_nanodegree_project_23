...
QT_MOC_LITERAL(22, 0), // ""
QT_MOC_LITERAL(23, 6), // "button"
QT_MOC_LITERAL(30, 25), // "on_confirmAddBook_clicked"
QT_MOC_LITERAL(56, 24) // "on_cancelAddBook_clicked"

    },
    "AddBook\0buttonPressed\0\0button\0"
    "on_confirmAddBook_clicked\0"
    "on_cancelAddBook_clicked"
};
...
void AddBook::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_confirmAddBook_clicked(); break;
        case 2: _t->on_cancelAddBook_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AddBook::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddBook::buttonPressed)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<AddBook, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>
...
// SIGNAL 0
void AddBook::buttonPressed(int _t1)
{
